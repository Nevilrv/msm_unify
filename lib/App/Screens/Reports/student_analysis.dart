...
import '../../../viewModel/report_student_view_model.dart';

class StudentAnalysisScreen extends StatefulWidget {
  const StudentAnalysisScreen({Key? key}) : super(key: key);
...
class _StudentAnalysisScreenState extends State<StudentAnalysisScreen> {
  ReportStudentViewModel reportStudentViewModel =
      Get.put(ReportStudentViewModel());
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<ReportStudentViewModel>(
                                builder: (controller) {
                                  if (controller.apiResponse.status ==
                                      Status.COMPLETE) {
                                    StudentResponseModel resp =
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        ...
                                                        child: const Text(
                                                          'City of the student as per passport',
                                                          style: TextStyle(
                                                            fontFamily:
                                                                'Roboto',
                                                            color: Colors.black,
        ...
        cells: [
          DataCell(
            Container(
              ...
              child: Text('${data!.data![index].intake}'),
            ),
          ),
          DataCell(
            Container(
              ...
              child: Text('${data!.data![index].institution}'),
            ),
          ),
          DataCell(
            Container(
              ...
              child:
                  Text('${data!.data![index].cityOfTheStudentAsPerPassport}'),
            ),
          ),
          DataCell(
            Container(
              ...
              child:
                  Text('${data!.data![index].stateOfTheStudentAsPerPassport}'),
            ),
          ),
          DataCell(
            Container(
              ...
              child: Text('${data!.data![index].applications}'),
            ),
          ),
          DataCell(
            Container(
              ...
              child: Text('${data!.data![index].tuitionDeposit}'),
            ),
          ),
          DataCell(
            Container(
              ...
              child: Text('${data!.data![index].studyPermitApproval}'),
            ),
          ),
          DataCell(
            Container(
              ...
              child: Text('${data!.data![index].studyPermitRefusal}'),
            ),
          ),
          DataCell(
            Container(
              ...
              child: Text('${data!.data![index].enrolledStudent}'),
            ),
          ),
          DataCell(
            Container(
              ...
              child: Text('${data!.data![index].transferedDropOut}'),
            ),
          ),
        ]);
  }
