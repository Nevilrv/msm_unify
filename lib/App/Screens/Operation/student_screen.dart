    ...
    return DataRow(cells: [
      DataCell(
        ...
        Container(
          ...
          child: Center(child: Text('${data!.data![index].studentId}')),
        ),
      ),
      DataCell(
        onTap: () {
        ...
        Container(
          ...
          child: Center(
            child: Center(child: Text('${data!.data![index].status}')),
          ),
        ),
      ),
      DataCell(
        ...
        Container(
          ...
          child:
              Center(child: Text('${data!.data![index].numberOfApplication}')),
        ),
      ),
      DataCell(
        onTap: () {
        ...
        Container(
          ...
          child: Center(child: Text('${data!.data![index].citizenship}')),
        ),
      ),
      DataCell(
        onTap: () {
        ...
        Container(
          ...
          child: Center(child: Text('${data!.data![index].firstName}')),
        ),
      ),
      DataCell(
        onTap: () {
        ...
        Container(
          ...
          child: Center(child: Text('${data!.data![index].lastName}')),
        ),
      ),
      DataCell(
        onTap: () {
        ...
        Container(
          ...
          child: Center(child: Text('${data!.data![index].mobileNo}')),
        ),
      ),
      DataCell(
        Container(
